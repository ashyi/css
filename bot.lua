...
❤️ made by : @ashkan_momeni
🤕 bot : @ashkan_momenibot
				...
				elseif (text:match("^(انلاینی)$") and not msg.forward_info_)then
					return tdcli_function({
						ID = "ForwardMessages",
						chat_id_ = msg.chat_id_,
						from_chat_id_ = msg.chat_id_,
				...
				elseif text:match("^(راهنما)$") then
					...
					local txt2 = '   ❤️ @ashkan_momeni  🤕 @ashkan_momenibot '
					return send(msg.chat_id_,msg.id_,txt,txt2)
